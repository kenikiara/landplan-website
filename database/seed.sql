...
INSERT INTO land_listings (title, slug, location, size, price, category, title_status, description, features, cover_image, featured, status) VALUES
 ('1/8 Acre Residential Plot', 'kitengela-1-8-acre', 'Kitengela, Kajiado', '1/8 Acre Plot', 1250000, 'Residential', 'Ready Title Deed',
  ...
  "Ready title deed\nElectricity on site\nWater access\nAll-weather road\nGated community", 'assets/img/land-kitengela.png', 1, 'published'),
 ('1/4 Acre Commercial Plot', 'ruiru-1-4-acre', 'Ruiru, Kiambu', '1/4 Acre Plot', 2850000, 'Commercial', 'Ready Title Deed',
  ...
  "Ready title deed\nTarmac frontage\nHigh foot traffic\nPower & water\nClose to town", 'assets/img/land-ruiru.png', 1, 'published'),
 ('1/8 Acre Residential Plot', 'joska-1-8-acre', 'Joska, Kamulu', '1/8 Acre Plot', 650000, 'Residential', 'Ready Title Deed',
  ...
  "Ready title deed\nAffordable pricing\nGrowing neighbourhood\nMurram road access", 'assets/img/land-joska.png', 1, 'published'),
 ('1/2 Acre Mixed-Use Plot', 'thika-1-2-acre', 'Thika, Kiambu', '1/2 Acre Plot', 3950000, 'Mixed Use', 'Ready Title Deed',
  ...
  "Ready title deed\nNear superhighway\nFlat, well-drained\nPower & water\nHigh appreciation", 'assets/img/land-thika.png', 1, 'published');

-- ---------- Houses ----------
INSERT INTO houses (title, slug, location, bedrooms, bathrooms, price, description, features, cover_image, featured, status) VALUES
 ('Modern 4-Bedroom Villa', 'runda-4bed-villa', 'Runda, Nairobi', 4, 4, 42000000, 'Elegant modern villa in the leafy suburb of Runda. Open-plan living, chef''s kitchen, landscaped garden and DSQ.', "Master ensuite\nDSQ\nLandscaped garden\nSolar water heating", 'assets/img/proj-villa.png', 1, 'published'),
 ('3-Bedroom Bungalow', 'kitengela-3bed-bungalow', 'Kitengela, Kajiado', 3, 2, 8900000, 'Well-finished 3-bedroom bungalow on an eighth of an acre in Kitengela. Move-in ready.', "All ensuite\nParking\nReady title", 'assets/img/svc-houses.png', 0, 'published'),
 ('2-Bedroom Apartment', 'ruiru-2bed-apartment', 'Ruiru, Kiambu', 2, 2, 5200000, 'Contemporary 2-bedroom apartment in a secure gated development in Ruiru with borehole water and backup power.', "Borehole water\nBackup power\nLift\nCCTV", 'assets/img/proj-apartments.png', 0, 'published'),
 ('5-Bedroom Maisonette', 'kiambu-5bed-maisonette', 'Kiambu Town, Kiambu', 5, 4, 22500000, 'Spacious family maisonette with a large compound in Kiambu Town.', "Family room\nStudy\nDSQ\nDouble garage", 'assets/img/proj-villa.png', 0, 'published'),
 ('3-Bedroom Townhouse', 'thika-3bed-townhouse', 'Thika, Kiambu', 3, 3, 9800000, 'Modern 3-bedroom townhouse in a gated court in Thika.', "Gated court\nAll ensuite\nPlayground", 'assets/img/svc-houses.png', 0, 'published'),
 ('4-Bedroom Townhouse', 'ngong-4bed-townhouse', 'Ngong, Kajiado', 4, 3, 13400000, 'Stylish 4-bedroom townhouse with hills views in Ngong.', "Hills view\nDSQ\nSolar heating", 'assets/img/proj-apartments.png', 0, 'published'),
 ('2-Bedroom Bungalow', 'athi-river-2bed-bungalow', 'Athi River, Machakos', 2, 1, 6300000, 'Cosy 2-bedroom starter home in Athi River.', "Ready title\nParking\nFenced", 'assets/img/svc-houses.png', 0, 'published'),
 ('5-Bedroom Luxury Villa', 'karen-5bed-villa', 'Karen, Nairobi', 5, 5, 65000000, 'Luxury villa on half an acre in Karen with a pool, home office and staff quarters.', "Swimming pool\nHome office\nStaff quarters\nMature garden", 'assets/img/proj-villa.png', 1, 'published');

-- ---------- Projects ----------
INSERT INTO projects (title, slug, location, description, cover_image, status, featured) VALUES
 ('Greenview Apartments', 'greenview-apartments', 'Ruiru, Kiambu', 'A modern residential apartment development offering affordable, quality urban living with shared amenities.', 'assets/img/proj-apartments.png', 'ongoing', 1),
 ('Acacia Gated Community', 'acacia-gated-community', 'Kitengela, Kajiado', 'A secure gated community of serviced plots and homes with a controlled entrance, perimeter wall and internal roads.', 'assets/img/proj-gate.png', 'completed', 1),
 ('Meadow Heights Estate', 'meadow-heights-estate', 'Thika, Kiambu', 'A master-planned estate with residential plots, green spaces and full infrastructure.', 'assets/img/proj-aerial.png', 'completed', 0),
 ('Sunset Villa', 'sunset-villa', 'Karen, Nairobi', 'A bespoke luxury villa designed and built end-to-end for a private client.', 'assets/img/proj-villa.png', 'completed', 0);

-- ---------- Services ----------
INSERT INTO services (title, slug, icon, excerpt, body, cover_image, sort, status) VALUES
 ('Land for Sale', 'land-for-sale', 'land', 'Residential, commercial, agricultural & mixed-use plots in prime locations.', 'We offer verified plots with genuine, ready title deeds across Kenya''s fastest-growing towns.', 'assets/img/svc-land.png', 1, 'published'),
 ('Architecture & Design', 'architecture-design', 'arch', 'Modern, functional and sustainable designs tailored to your lifestyle.', 'Our architects deliver modern, functional and sustainable designs tailored to your lifestyle and budget.', 'assets/img/svc-arch.png', 2, 'published'),
 ('Building & Construction', 'building-construction', 'construction', 'Quality construction, on time and within budget. We build your vision.', 'From foundation to finishing, we deliver quality construction on time and within budget.', 'assets/img/svc-construction.png', 3, 'published'),
 ('Project Development', 'project-development', 'project', 'From concept to completion, we develop impactful residential & commercial projects.', 'We develop impactful residential and commercial projects from concept to completion.', 'assets/img/svc-project.png', 4, 'published'),
 ('Houses for Sale', 'houses-for-sale', 'house', 'Move-in ready homes in great neighborhoods. Find your dream home.', 'Browse move-in ready homes in great neighbourhoods across the region.', 'assets/img/svc-houses.png', 5, 'published');

-- ---------- Articles / blog ----------
INSERT INTO articles (title, slug, excerpt, body, cover_image, category, status, published_at) VALUES
 ('The Complete Guide to Buying Land in Kenya (2026)', 'guide-to-buying-land-in-kenya', 'Everything you need to know before you buy — from due diligence to title transfer.', '<p>Buying land in Kenya is one of the surest ways to build long-term wealth — but only if you do it right. This guide walks you through search, due diligence, agreements and title transfer.</p>', 'assets/img/land-kitengela.png', 'Land Buying', 'published', '2026-01-15 09:00:00'),
 ('A Practical Guide to Building Your Home in Kenya', 'guide-to-building-your-home', 'Costs, approvals, timelines and how to avoid the most common building mistakes.', '<p>From approvals to finishing, building a home in Kenya has many moving parts. Here is a practical, step-by-step overview.</p>', 'assets/img/svc-construction.png', 'Building', 'published', '2026-02-02 09:00:00'),
 ('Kenya Real Estate Market Trends 2026', 'kenya-real-estate-trends-2026', 'Where prices are heading and which corridors offer the best value this year.', '<p>We break down the data on where land and housing demand is growing fastest in 2026.</p>', 'assets/img/proj-aerial.png', 'Market Trends', 'published', '2026-03-10 09:00:00'),
 ('Why Thika Remains a Smart Bet for Land Investors', 'why-thika-is-a-smart-bet', 'Infrastructure, industry and demand keep pushing Thika land values up.', '<p>Thika''s superhighway, industry and growing population make it a standout for land investors.</p>', 'assets/img/land-thika.png', 'Investment', 'published', '2026-03-22 09:00:00'),
 ('5 Legal Checks to Run Before You Buy Any Property', '5-legal-checks-before-you-buy', 'A quick checklist that can save you from costly land-buying fraud.', '<p>Run these five checks — search, survey, rates, land control board and identity — before any purchase.</p>', 'assets/img/land-ruiru.png', 'Legal', 'published', '2026-04-05 09:00:00'),
 ('Gated Communities: Are They Worth the Premium?', 'are-gated-communities-worth-it', 'Weighing security, amenities and resale value against the price.', '<p>Gated communities cost more up front. Here is how to decide whether the premium pays off for you.</p>', 'assets/img/proj-gate.png', 'Lifestyle', 'published', '2026-04-20 09:00:00');
